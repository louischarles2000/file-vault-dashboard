...
const VerifySMSOTP = () => {
  ...
  if(!sent){
    return (
      <div className='mx-auto py-8 flex flex-col justify-center'>
        <h3 className="font-light text-[#000] text-sm p-3">Your account is not verified</h3>
  ...
  <div className='mx-auto py-8'>
    <h3 className="font-light text-[#000] text-sm p-3">Confirm Your Email Address</h3>
